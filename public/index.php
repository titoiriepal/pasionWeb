...
$router->get('/admin/usuarios/cambiar_password', [UsuarioController::class, 'cambiarPassword']);
$router->post('/admin/usuarios/cambiar_password', [UsuarioController::class, 'cambiarPassword']);
$router->get('/admin/usuarios/mensaje-password', [LoginController::class, 'mensajePassword']);
