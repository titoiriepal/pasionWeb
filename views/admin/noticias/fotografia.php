...
<div class="muestraFotos">
    ...
    ?>
        ...
        <div class="contienefoto">
            ...
            <img src="/imagenes/<?php echo $fotografia->carpeta . '/' . trim($fotografia->ruta); ?>" id="<?php echo $fotografia->id ?>" class="adminFoto <?php if ($fotografia->id == $idFoto) {
                                                                                                                                                            echo 'foto_selected';
                                                                                                                                                        } ?>" alt="Foto Galeria">
...
<div class="contenedor">
    ...
    echo $paginacion;
    ?>
    <!-- <form action="<?php if ($_POST['id']) {
                            echo '/admin/noticias/actualizar?id=' . $_POST['id'];
                        } else {
                            echo '/admin/noticias/crear';
            ...
            />
            <input type="submit" class="boton" value="<?php if ($_POST['id']) {
...
<?php
$script = '<script src="/build/js/seleccionarFotografia.js" defer>';
?>