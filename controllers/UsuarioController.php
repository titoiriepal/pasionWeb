...
class UsuarioController
{
    ...
    public static function cambiarPassword(Router $router)
    {
        ...
        if (empty($usuario)) {
            //Volver a la página de usuarios si no se encuentra el usuario
            header('Location: /admin');
        }
        ...
        $router->render('admin/usuarios/reset-password', [
            'title' => 'Iriépal es pasión || Cambiar Contraseña Usuario',
            'usuario' => $usuario,
            'alertas' => $alertas,
            'error' => $error
    ...
    {
        $router->render('admin/usuarios/mensaje-password', [
